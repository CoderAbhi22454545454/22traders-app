            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="p-2 rounded-lg text-blue-900 hover:text-blue-600 hover:bg-blue-100 transition-colors"
                  aria-haspopup="menu"
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <div className="mt-0.5 text-sm font-medium text-gray-900 truncate">{user.name}</div>
                    </div>
                    <div className="py-1">
                      <button
                        type="button"
                      ...
                      >
                        <ClipboardDocumentCheckIcon className="h-4 w-4 mr-2 text-green-600" />
                        Synced
                      </button>
                      <button
                        onClick={onLogout}
